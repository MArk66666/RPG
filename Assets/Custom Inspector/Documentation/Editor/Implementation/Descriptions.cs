...
namespace CustomInspector.Documentation
{
    public static class CustomInspectorAttributeDescriptions
    {
        public static Dictionary<NewPropertyD, string> descriptions = new()
        {
            ...
            "Changes the color of the GUI from one field or the entire GUI." },
            ...
            "\nIf the file-name doesnt match the type of your generic class, you can insert a custom fileName to locate the file" },
