...
namespace CustomInspector.Editor
{
    ...
    public class ForceFillAttributeDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                DrawProperties.DrawFieldWithMessage(position, label, property, info.errorMessage, MessageType.Error);
                return;
            }
        ...
        static PropInfo GetInfo(SerializedProperty property, ForceFillAttribute attribute)
        {
        ...
        class PropInfo
        {
            ...
            public PropInfo(SerializedProperty property, ForceFillAttribute attribute)
            {
                ...
                if ((attribute.notAllowed?.Length ?? 0) < 1)
                {
                    ...
                    else if (propSystemType == typeof(string)) //unity auto converts string to empty string
