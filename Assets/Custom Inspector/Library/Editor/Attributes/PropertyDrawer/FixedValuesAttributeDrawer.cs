...
namespace CustomInspector.Editor
{
    ...
    public class FixedValuesAttributeDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                DrawProperties.DrawFieldWithMessage(position, label, property, errorMessage: "FixedValuesAttribute: No values given to choose from", MessageType.Error);
                return;
            }
            ...
            {
                DrawProperties.DrawFieldWithMessage(position, label, property, errorMessage: $"FixedValuesAttribute: Not all given values are type of {fieldInfo.FieldType.Name}", MessageType.Error);
                return;
            }
