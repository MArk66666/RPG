...
namespace CustomInspector.Editor
{
    ...
    public class CopyPasteAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                DrawProperties.DrawFieldWithMessage(position, label, property, $"Clipboard doesnt support {property.propertyType}", MessageType.Error);
                return;
            }
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            if (!IsTypeSupported(property.propertyType))
                ...
                return EditorGUIUtility.singleLineHeight + DrawProperties.GetPropertyHeight(label, property) + spaceBehind;
        }
