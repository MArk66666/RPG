...
namespace CustomInspector.Editor
{
    ...
    public class GetSetAttributeDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                DrawProperties.DrawFieldWithMessage(position, label, property, "get-method: " + e.Message, MessageType.Error);
                return;
            }
            ...
            {
                DrawProperties.DrawFieldWithMessage(position, label, property, "set-method: " + e.Message, MessageType.Error);
                return;
            }
